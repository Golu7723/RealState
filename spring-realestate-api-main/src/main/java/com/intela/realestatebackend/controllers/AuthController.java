...
public class AuthController {
    ...
    @GetMapping("/me")
    public ResponseEntity<LoggedUserResponse> getLoggedInUserProfile(HttpServletRequest request) {
        return ResponseEntity.ok(this.authService.fetchLoggedInUserByToken(request));
    }
    ...
    public ResponseEntity<String> resetPassword(
        ...
        authService.resetPassword(servletRequest, request);
        return ResponseEntity.accepted().body("Password reset successfully");
    }
