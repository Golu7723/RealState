...
public class UserController {
        ...
        @Operation(summary = "Updates user profile", description = "Uploads a user profile JSON object", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(encoding = {
        ...
        @Operation(summary = "Uploads profile image", description = "Uploads profile image", requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(encoding = {
                        @Encoding(name = "image", contentType = "image/png, image/jpeg")
        }, mediaType = "multipart/form-data", schemaProperties = {
                        @SchemaProperty(name = "images", schema = @Schema(type = "string", format = "binary"))
        }
