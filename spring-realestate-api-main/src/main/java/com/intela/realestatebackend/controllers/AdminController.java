...
public class AdminController {
    ...
    public ResponseEntity<List<IDImageResponse>> getIdImagesByUserId(@PathVariable Integer userId,
    ...
    public ResponseEntity<UpdateAccountResponse> updateAccount(@PathVariable Integer userId,
