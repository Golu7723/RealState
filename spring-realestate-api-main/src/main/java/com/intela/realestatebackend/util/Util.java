...
public class Util {
    ...
    public static User getUserByToken(HttpServletRequest request, JwtService jwtService,
    ...
    public static List<PropertyImageResponse> getImageByPropertyId(int propertyId,
    ...
    public static void updateProfileFromRequest(Profile existingInfo, UpdateProfileRequest request)
    ...
    public static Map<String, Object> updateAccountFromRequest(User user, UpdateAccountRequest request)
            throws IllegalAccessException {
    ...
    public static ProfileImage multipartFileToProfileImage(User user, MultipartFile image, ImageService imageService)
            throws IOException {
